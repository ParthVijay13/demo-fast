...
const AppSidebar: React.FC = () => {
  ...
  // console.log(localStorage.getItem('permissions')?.split(','));
//    useEffect(() => {
//   const stored = localStorage.getItem('permissions') || "";
//   const permissions = stored.split(",").filter(Boolean);   // e.g. ['dashboard','orders',…]
//   const allowed = allNavItems.filter(item => permissions.includes(item.tag));
//   console.log(allowed)
//   setNavItems(allowed);
// }, []);
