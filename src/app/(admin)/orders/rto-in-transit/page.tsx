...
const RtoInTransitOrdersPage: React.FC = () => {
  ...
  // Set the status to rto-in-transit when component mounts
  useEffect(() => {
    if (filters.status !== 'rto-in-transit') {
      dispatch(setStatusAction('rto-in-transit'));
    }
...
export default RtoInTransitOrdersPage;
