...
const ReadyToShipOrdersPage: React.FC = () => {
  ...
  // Set the status to ready-to-ship when component mounts
  useEffect(() => {
    if (filters.status !== 'ready-to-ship') {
      dispatch(setStatusAction('ready-to-ship'));
    }
