...
const ReadyForPickupOrdersPage: React.FC = () => {
  ...
  // Set the status to ready-for-pickup when component mounts
  useEffect(() => {
    if (filters.status !== 'ready-for-pickup') {
      dispatch(setStatusAction('ready-for-pickup'));
    }
...
export default ReadyForPickupOrdersPage;
